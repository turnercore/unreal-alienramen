...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Returns game-scope completed conversation tags currently tracked by Parley runtime state."))
	...
	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast delegate exposed to Blueprint for dialogue lifecycle updates."))
	...
	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when a conversation session starts. Params: ConversationTag, SpeakerTag, PlayerSlotTag."))
	FParleyOnConversationStarted OnConversationStarted;

	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when a conversation session ends. Params: ConversationTag, SpeakerTag, PlayerSlotTag, bCompleted."))
	FParleyOnConversationEnded OnConversationEnded;

	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when a dialogue line is delivered to clients. Params: SpeakerTag, ConversationTag, PlayerSlotTag."))
	FParleyOnLineDelivered OnLineDelivered;

	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when a submitted important choice branch is selected. Params: ChoiceBranchId, ConversationTag, SpeakerTag, PlayerSlotTag."))
	FParleyOnImportantChoiceMade OnImportantChoiceMade;

	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when relationship level threshold changes for a speaker. Params: SpeakerTag, PlayerSlotTag, OldLevel, NewLevel."))
	FParleyOnRelationshipLevelChanged OnRelationshipLevelChanged;

	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when a conversation is completed for a player slot. Save bridges should persist and mark dirty."))
	FParleyOnConversationCompleted OnParleyConversationCompleted;

	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when relationship points are mutated by dialogue. Save bridges should persist and mark dirty."))
	FParleyOnRelationshipChanged OnRelationshipChanged;

	UPROPERTY(BlueprintAssignable, Category = "Alien Ramen|Dialogue", meta = (ToolTip = "Broadcast when progression tags are added/removed by dialogue. Save bridges should persist and mark dirty."))
