...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Parley|Faction", meta = (ToolTip = "Executes a Parley faction runtime operation."))
	...
	UFUNCTION(BlueprintPure, Category = "Parley|Faction", meta = (ToolTip = "Returns Parley faction runtime state without mutation."))
