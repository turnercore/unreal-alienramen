...
private:
	struct FConversationEntry
	{
		...
		TWeakObjectPtr<UParleyConversationAsset> Asset;
	};
	...
	FReply HandleCycleConversationBand(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset);
	FReply HandleSetConversationBand(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset, int32 TargetBand);
	void CommitConversationPriority(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset, const FText& NewText, ETextCommit::Type CommitType);
	FReply HandleToggleConversationRepeatable(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset);
	FReply HandleToggleConversationImportant(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset);
	void CommitConversationDisplayName(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset, const FText& NewText, ETextCommit::Type CommitType);
	FReply HandleAddConversationLockedByTag(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset);
	FReply HandleRemoveConversationLockedByTag(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset, int32 TagIndex);
	void HandleConversationLockedByTagChanged(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset, int32 TagIndex, FGameplayTag NewTag);
	void CommitConversationRequiredTags(TWeakObjectPtr<UParleyConversationAsset> ConversationAsset, const FGameplayTagContainer& NewTags);
