...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Alien Ramen|UI|HUD", meta = (ToolTip = "Runs a HUD initialization or control operation."))
	...
	UFUNCTION(BlueprintCallable, Category = "Alien Ramen|UI|HUD|Emotion", meta = (ToolTip = "Controls or queries HUD emotion rendering behavior."))
	...
	UFUNCTION(BlueprintPure, Category = "Alien Ramen|UI|HUD|Emotion", meta = (ToolTip = "Returns HUD emotion rendering state without side effects."))
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "Alien Ramen|UI|HUD", meta = (ToolTip = "Blueprint hook fired when HUD initialization is requested."))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Alien Ramen|UI|HUD|Emotion", meta = (AllowPrivateAccess = "true", ToolTip = "Configures HUD emotion rendering behavior."))
